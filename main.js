...
do {
let lineM = '⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ ⋯ 》'
option = await question('[ ℹ ] Select an option:\n1. With QR code\n2. With 8-digit text code\n---> ')
...
rl.close()  
        ...
        setTimeout(async () => {
            ...
            console.log(chalk.yellow('[ ℹ ] enter the pairing code on WhatsApp.'));
...
if (opcion == '1' || methodCodeQR) {
    console.log(chalk.yellow('[ ℹ ] Scan the QR code.'));
 }}
  if (connection == 'open') {
console.log(chalk.yellow('[ ℹ ] Connected successfully.'));
  }
