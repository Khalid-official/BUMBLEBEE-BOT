...
const handler = async (m, {conn, usedPrefix, command}) => {
  ...
  if (room == undefined) return conn.sendButton(m.chat, tradutor.texto1, wm, null, [[tradutor.texto2, `https://github.com/Khalid-official ${usedPrefix}ttt ${tradutor.texto3}`]], m);
