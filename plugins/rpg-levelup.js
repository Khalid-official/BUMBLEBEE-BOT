...
*[❗𝐈𝐍𝐅𝐎❗] Hey there, ${name}! You're not ready to level up just yet. It seems like you need to munch up *${max - user.exp}* more XP to level up and reach new heights! Keep going, and the bots will be singing your praises soon! 🚀*
`.trim();
...
*[❗𝐈𝐍𝐅𝐎❗] Woo-hoo, ${name}! You've soared to new heights and reached level ${user.level}! 🎉 Time to celebrate! 🎊
