...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `https://github.com/Khalid-official ${tradutor.texto1} ${usedPrefix + command}*`;
      let out;
      try {
      ...
      else return m.reply(`https://github.com/Khalid-official ${tradutor.texto2} ${usedPrefix}s https://telegra.ph/file/0dc687c61410765e98de2.jpg*`);
    }
  } catch (e) {
    console.error(e);
    if (!stiker) stiker = e;
   ...
   else return m.reply(`https://github.com/Khalid-official ${tradutor.texto3}` + ` ${usedPrefix + command}*`);
  }
};
handler.help = ['sfull'];
