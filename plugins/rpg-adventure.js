...
*[❗𝐈𝐍𝐅𝐎❗] Requires at least 80 ❤️Healths for the adventure!!
...
*[❗𝐈𝐍𝐅𝐎❗] You're already adventure!!, please wait* *🕐${timers.toTimeString()}*
`.trim())
    const rewards = reward(user)
    let text = 'https://github.com/Khalid-official *[❗𝐈𝐍𝐅𝐎❗] you\'ve been adventure and lost*'
