...
export async function before(m) {
    ...
    if (room) {
        ...
        let str = `
${isWin ? `*[❗𝐈𝐍𝐅𝐎❗] @${winner.split('@')[0]} You are the winner 🎉* *+${winScore} XP*` : isTie ? `*[❗𝐈𝐍𝐅𝐎❗] Game over, with a draw* *+${playScore} XP*` : `*[❗𝐈𝐍𝐅𝐎❗] Now is your turn* ${['❎', '⭕'][1 * room.game._currentTurn]} (@${room.game.currentTurn.split('@')[0]})`} 
...
[❗𝐈𝐍𝐅𝐎❗]  Type *surrender* to give up 
`.trim()
